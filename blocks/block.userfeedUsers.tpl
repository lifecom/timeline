			...
			<div class="stream-settings-userlist">
				<div class="search-form-wrapper">
					<div class="search-input-wrapper">
						...
						<div onchange="ls.userfeed.appendUser();" class="input-submit"></div>
					</div>
				</div>
						...
						{foreach from=$aUserfeedSubscribedUsers item=oUser}
							...
							{if !isset($aUserfeedFriends.$iUserId)}
								<li><input class="userfeedUserCheckbox input-checkbox"
											...
											id="usf_u_{$iUserId}"
											checked="checked"
											onchange="if (jQuery(this).prop('checked')) { ls.userfeed.subscribe('users',{$iUserId}) } else { ls.userfeed.unsubscribe('users',{$iUserId}) } " />
